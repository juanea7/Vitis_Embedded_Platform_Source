...
proc create_hier_cell_static_region { parentCell nameHier } {
 ...
 #] $axi_interconnect_post_sniffer
  ...
  connect_bd_net -net base_clocking_clk_out2 [get_bd_pins clkwiz_sysclks_clk_out2] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_mgmt/ACLK] [get_bd_pins axi_interconnect_user/ACLK] [get_bd_pins axi_interconnect_monitor_traces/ACLK] [get_bd_pins axi_interconnect_user/M00_ACLK] [get_bd_pins base_clocking/clkwiz_sysclks_clk_out2] [get_bd_pins debug_bridge_xvc/s_axi_aclk] [get_bd_pins monitor_0/s00_axi_aclk] [get_bd_pins monitor_0/s01_axi_aclk] [get_bd_pins monitor_0/s02_axi_aclk] [get_bd_pins monitor_0/s_sniffer_in_axi_aclk] [get_bd_pins monitor_0/m_sniffer_out_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins pr_isolation_expanded/clkwiz_sysclks_clk_out2] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  ...
  connect_bd_net -net base_clocking_interconnect_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_mgmt/ARESETN] [get_bd_pins axi_interconnect_user/ARESETN] [get_bd_pins base_clocking/psreset_ctrlclk_interconnect_aresetn] [get_bd_pins debug_bridge_xvc/s_axi_aresetn] [get_bd_pins monitor_0/s00_axi_aresetn] [get_bd_pins monitor_0/s01_axi_aresetn] [get_bd_pins monitor_0/s02_axi_aresetn] [get_bd_pins monitor_0/s_sniffer_in_axi_aresetn] [get_bd_pins monitor_0/m_sniffer_out_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins pr_isolation_expanded/psreset_ctrlclk_interconnect_aresetn]
