...
proc create_hier_cell_static_region { parentCell nameHier } {
 ...
 #] $axi_interconnect_post_sniffer
  ...
  set_property -dict [ list \
    ...
    CONFIG.C_S01_AXI_ADDR_WIDTH {17.0} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_user_M05_AXI [get_bd_intf_pins monitor_0/S02_AXI] [get_bd_intf_pins axi_interconnect_user/M05_AXI]
  ...
  # [MONITOR] GPIO
  connect_bd_intf_net -intf_net axi_interconnect_user_M06_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_interconnect_user/M06_AXI]
  ...
  connect_bd_net -net base_clocking_clk_out2 [get_bd_pins clkwiz_sysclks_clk_out2] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_mgmt/ACLK] [get_bd_pins axi_interconnect_user/ACLK] [get_bd_pins axi_interconnect_user/M00_ACLK] [get_bd_pins base_clocking/clkwiz_sysclks_clk_out2] [get_bd_pins debug_bridge_xvc/s_axi_aclk] [get_bd_pins monitor_0/s00_axi_aclk] [get_bd_pins monitor_0/s01_axi_aclk] [get_bd_pins monitor_0/s02_axi_aclk] [get_bd_pins monitor_0/s_sniffer_in_axi_aclk] [get_bd_pins monitor_0/m_sniffer_out_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins pr_isolation_expanded/clkwiz_sysclks_clk_out2] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x81100000 -range 0x00020000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/S01_AXI/S01_AXI_mem] -force
  assign_bd_address -offset 0x81180000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/S02_AXI/S02_AXI_mem] -force
  # [MONITOR] AXI Sniffer
