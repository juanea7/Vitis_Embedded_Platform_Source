# Vitis Monitor DFX Platform for the ZCU102 Board

***Version: 2024.2***

This platform comes with common hardware features on the ZCU102 board like GEM and PS DDR4. The platform software includes OpenCV in PetaLinux. It is useful as a base platform with monitoring capabilities for exercising Vitis capabilities and topologies on the ZCU102 board.
...
| Type              | Value                              |
| ----------------- | ---------------------------        |
| Release Version   | xilinx_zcu102_monitor_dfx_202420_1 |
