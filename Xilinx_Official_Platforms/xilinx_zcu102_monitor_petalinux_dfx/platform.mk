...
#platform specific
PLATFORM = xilinx_zcu102_monitor_dfx
CPU_ARCH = a53
BOARD    = zcu102-rev1.0
...
#flow related
PREBUILT_LINUX_PATH ?= /opt/xilinx/platform/xilinx-zynqmp-common-v2024.2
ifneq ($(wildcard $(TOP_DIR)/xilinx-zynqmp-common-v2024.2),)
PREBUILT_LINUX_PATH ?= $(TOP_DIR)/xilinx-zynqmp-common-v2024.2
endif
