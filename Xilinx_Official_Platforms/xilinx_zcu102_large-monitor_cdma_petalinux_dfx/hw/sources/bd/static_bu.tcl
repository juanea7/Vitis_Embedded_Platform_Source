...
proc create_hier_cell_static_region { parentCell nameHier } {
  ...
  # Create instance: axi_interconnect_user, and set properties
  #set axi_interconnect_user [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_monitor_traces ]
  #set_property -dict [ list \
  # CONFIG.NUM_MI {1} \
  # CONFIG.NUM_SI {1} \
 #] $axi_interconnect_user
 ...
 #] $axi_interconnect_post_sniffer
  ...
  #connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins axi_interconnect_monitor_traces/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_user_M04_AXI [get_bd_intf_pins monitor_cdma_0/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_user/M04_AXI]
  #connect_bd_intf_net -intf_net axi_interconnect_monitor_traces_M00_AXI [get_bd_intf_pins monitor_0/S02_AXI] [get_bd_intf_pins axi_interconnect_monitor_traces/M00_AXI]
  ...
  # [MONITOR] GPIO
  connect_bd_intf_net -intf_net axi_interconnect_user_M06_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_interconnect_user/M05_AXI]
...
proc create_root_design { parentCell } {
  ...
  # [MONITOR] CDMA
  assign_bd_address -offset 0x81010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_cdma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x81100000 -range 0x00080000 -target_address_space [get_bd_addr_spaces static_region/monitor_cdma_0/Data] [get_bd_addr_segs static_region/monitor_0/S01_AXI/S01_AXI_mem] -force
  assign_bd_address -offset 0x81180000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/monitor_cdma_0/Data] [get_bd_addr_segs static_region/monitor_0/S02_AXI/S02_AXI_mem] -force
