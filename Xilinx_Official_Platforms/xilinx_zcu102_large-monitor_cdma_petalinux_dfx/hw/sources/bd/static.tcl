...
proc create_hier_cell_pr_isolation_expanded { parentCell nameHier } {
  ...
  connect_bd_net -net clkwiz_kernel2_clk_out1_1 [get_bd_pins clkwiz_kernel2_clk_out1] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins psreset_regslice_data_pr/slowest_sync_clk] [get_bd_pins regslice_data_periph_1/aclk] [get_bd_pins regslice_ddrmem_2/aclk] [get_bd_pins regslice_ddrmem_3/aclk]
  ...
  connect_bd_net -net psreset_regslice_pr_interconnect_aresetn [get_bd_pins psreset_regslice_data_pr_interconnect_aresetn] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins psreset_regslice_data_pr/peripheral_aresetn] [get_bd_pins regslice_data_periph_1/aresetn] [get_bd_pins regslice_ddrmem_2/aresetn] [get_bd_pins regslice_ddrmem_3/aresetn]
...
proc create_hier_cell_static_region { parentCell nameHier } {
  ...
  # [MONITOR]
  create_bd_pin -dir I static_region_MISO
  create_bd_pin -dir O static_region_SCLK
  create_bd_pin -dir O static_region_CS_n
  create_bd_pin -dir O static_region_MOSI
  ...
  set axi_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_0 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {2} \
   CONFIG.NUM_SI {1} \
 ] $axi_interconnect_0
  ...
  set axi_interconnect_mgmt [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_mgmt ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {1} \
  ...
  set axi_interconnect_user [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_user ]
  set_property -dict [ list \
   CONFIG.NUM_MI {6} \
   CONFIG.NUM_SI {1} \
 ] $axi_interconnect_user

 # [MONITOR] AXI interconnects for sniffing bus to the accelerators

  # Create instance: axi_interconnect_pre_sniffer, and set properties
  #set axi_interconnect_pre_sniffer [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_pre_sniffer ]
  #set_property -dict [ list \
  # CONFIG.NUM_MI {1} \
  # CONFIG.NUM_SI {1} \
 #] $axi_interconnect_pre_sniffer

  # Create instance: axi_interconnect_post_sniffer, and set properties
  #set axi_interconnect_post_sniffer [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_post_sniffer ]
  #set_property -dict [ list \
  # CONFIG.NUM_MI {1} \
  # CONFIG.NUM_SI {1} \
 #] $axi_interconnect_post_sniffer
  ...
  # [MONITOR] Create instance: monitor_0, and set properties
  set monitor_0 [ create_bd_cell -type ip -vlnv cei.upm:user:monitor:1.0 monitor_0 ]
  set_property -dict [ list \
    CONFIG.CLK_FREQ {100}  \
    CONFIG.SCLK_FREQ {20}  \
    ...
    CONFIG.NUMBER_PROBES {4}   \
    CONFIG.COUNTER_BITS {32}   \
    CONFIG.POWER_DEPTH {131072}  \
    CONFIG.TRACES_DEPTH {4096} \
    CONFIG.AXI_SNIFFER_ENABLE {true} \
    CONFIG.AXI_SNIFFER_DATA_WIDTH {32}  \
    CONFIG.C_S00_AXI_ADDR_WIDTH {4} \
    CONFIG.C_S00_AXI_DATA_WIDTH {32} \
    CONFIG.C_S01_AXI_ADDR_WIDTH {20.0} \
    CONFIG.C_S01_AXI_DATA_WIDTH {32} \
    CONFIG.C_S02_AXI_ADDR_WIDTH {16.0} \
    CONFIG.C_S02_AXI_DATA_WIDTH {128} \
  ] $monitor_0

  # Create instance: monitor_cdma_0_interconnect, and set properties
  set monitor_cdma_0_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect monitor_cdma_0_interconnect ]
  set_property -dict [ list \
   CONFIG.NUM_MI {3} \
   CONFIG.NUM_SI {1} \
 ] $monitor_cdma_0_interconnect

  # Create instance: axi_interconnect_cdma_0, and set properties
  set axi_interconnect_cdma_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect axi_interconnect_cdma_0 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {1} \
 ] $axi_interconnect_cdma_0

  # Create instance: monitor_cdma_0, and set properties
  set monitor_cdma_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_cdma:4.1 monitor_cdma_0 ]
  set_property -dict [list \
  ...
  # [MONITOr] Create instance: axi_gpio_0, and set properties # Test: 4 probes para ver con el gpio lo que va pasando con los aceleradores
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins axi_interconnect_cdma_0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  # [MONITOR]
  connect_bd_intf_net -intf_net axi_interconnect_user_M03_AXI [get_bd_intf_pins monitor_0/S00_AXI] [get_bd_intf_pins axi_interconnect_user/M03_AXI]
  connect_bd_intf_net -intf_net monitor_cdma_0_M_AXI [get_bd_intf_pins monitor_cdma_0_interconnect/S00_AXI] [get_bd_intf_pins monitor_cdma_0/M_AXI]
  connect_bd_intf_net -intf_net monitor_cdma_0_interconnect_M00_AXI [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD] [get_bd_intf_pins monitor_cdma_0_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net monitor_cdma_0_interconnect_M01_AXI [get_bd_intf_pins monitor_0/S01_AXI] [get_bd_intf_pins monitor_cdma_0_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net monitor_cdma_0_interconnect_M02_AXI [get_bd_intf_pins monitor_0/S02_AXI] [get_bd_intf_pins monitor_cdma_0_interconnect/M02_AXI]
  #connect_bd_intf_net -intf_net axi_interconnect_user_M04_AXI [get_bd_intf_pins monitor_0/S01_AXI] [get_bd_intf_pins axi_interconnect_user/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_user_M04_AXI [get_bd_intf_pins monitor_cdma_0/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_cdma_0/M00_AXI]
  connect_bd_intf_net -intf_net control_userpf_monitor_presniffer [get_bd_intf_pins monitor_0/s_sniffer_in_axi] [get_bd_intf_pins pr_isolation_expanded/regslice_control_userpf_M_AXI]
  connect_bd_intf_net -intf_net control_userpf_monitor_postsniffer [get_bd_intf_pins regslice_control_userpf_M_AXI] [get_bd_intf_pins monitor_0/m_sniffer_out_axi]

  # [MONITOR] GPIO
  connect_bd_intf_net -intf_net axi_interconnect_user_M06_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_interconnect_user/M04_AXI]
  ...
  connect_bd_net -net base_clocking_clk_out2 [get_bd_pins clkwiz_sysclks_clk_out2] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_mgmt/ACLK] [get_bd_pins axi_interconnect_user/ACLK] [get_bd_pins base_clocking/clkwiz_sysclks_clk_out2] [get_bd_pins debug_bridge_xvc/s_axi_aclk] [get_bd_pins monitor_0/s00_axi_aclk] [get_bd_pins monitor_0/s01_axi_aclk] [get_bd_pins monitor_0/s02_axi_aclk] [get_bd_pins monitor_0/s_sniffer_in_axi_aclk] [get_bd_pins monitor_0/m_sniffer_out_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins pr_isolation_expanded/clkwiz_sysclks_clk_out2] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins monitor_cdma_0/m_axi_aclk] [get_bd_pins monitor_cdma_0/s_axi_lite_aclk] [get_bd_pins monitor_cdma_0_interconnect/ACLK] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins axi_interconnect_cdma_0/ACLK]
  connect_bd_net -net base_clocking_clk_out4 [get_bd_pins clkwiz_kernel2_clk_out1] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk] [get_bd_pins axi_vip_2/aclk] [get_bd_pins axi_vip_data_m00_axi_1/aclk] [get_bd_pins base_clocking/clkwiz_kernel2_clk_out1] [get_bd_pins pr_isolation_expanded/clkwiz_kernel2_clk_out1] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  ...
  connect_bd_net -net base_clocking_interconnect_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_mgmt/ARESETN] [get_bd_pins axi_interconnect_user/ARESETN] [get_bd_pins base_clocking/psreset_ctrlclk_interconnect_aresetn] [get_bd_pins monitor_0/s00_axi_aresetn] [get_bd_pins monitor_0/s01_axi_aresetn] [get_bd_pins monitor_0/s02_axi_aresetn] [get_bd_pins monitor_0/s_sniffer_in_axi_aresetn] [get_bd_pins monitor_0/m_sniffer_out_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins pr_isolation_expanded/psreset_ctrlclk_interconnect_aresetn] [get_bd_pins monitor_cdma_0/s_axi_lite_aresetn] [get_bd_pins monitor_cdma_0_interconnect/ARESETN] [get_bd_pins axi_interconnect_cdma_0/ARESETN] [get_bd_pins axi_interconnect_cdma_0/ARESETN] 
  ...
  connect_bd_net -net pr_isolation_expanded_interconnect_aresetn1 [get_bd_pins axi_vip_0/aresetn] [get_bd_pins axi_vip_1/aresetn] [get_bd_pins axi_vip_data_m00_axi_1/aresetn] [get_bd_pins pr_isolation_expanded/psreset_regslice_data_pr_interconnect_aresetn]
  ...
  # [MONITOR] External port connections
  connect_bd_net -net monitor_0_SPI_MISO [get_bd_pins static_region_MISO] [get_bd_pins monitor_0/SPI_MISO]
  connect_bd_net -net monitor_0_SPI_SCLK [get_bd_pins static_region_SCLK] [get_bd_pins monitor_0/SPI_SCLK]
  connect_bd_net -net monitor_0_SPI_CS_n [get_bd_pins static_region_CS_n]  [get_bd_pins monitor_0/SPI_CS_n]
  connect_bd_net -net monitor_0_SPI_MOSI [get_bd_pins static_region_MOSI] [get_bd_pins monitor_0/SPI_MOSI]
  connect_bd_net -net monitor_0_intr [get_bd_pins monitor_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net monitor_cdma_0_cdma_introut [get_bd_pins monitor_cdma_0/cdma_introut] [get_bd_pins xlconcat_0/In1]
  # [MONITOR] GPIO (test)
  connect_bd_net -net monitor_0_probes_gpio [get_bd_pins monitor_0/probes] [get_bd_pins axi_gpio_0/gpio_io_o]
...
proc create_root_design { parentCell } {
  ...
  # [MONITOR]
  connect_bd_net -net static_region_monitor_0_SPI_MISO [get_bd_ports MISO] [get_bd_pins static_region/static_region_MISO]
  connect_bd_net -net static_region_monitor_0_SPI_SCLK [get_bd_ports SCLK] [get_bd_pins static_region/static_region_SCLK]
  connect_bd_net -net static_region_monitor_0_SPI_CS_n [get_bd_ports CS_n]  [get_bd_pins static_region/static_region_CS_n]
  connect_bd_net -net static_region_monitor_0_SPI_MOSI [get_bd_ports MOSI] [get_bd_pins static_region/static_region_MOSI]
  ...
  # [MONITOR]
  assign_bd_address -offset 0x81000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/S00_AXI/S00_AXI_reg] -force
  #assign_bd_address -offset 0x81100000 -range 0x00080000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/S01_AXI/S01_AXI_mem] -force
  #assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/S02_AXI/S02_AXI_mem] -force
  # [MONITOR] CDMA
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_cdma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces static_region/monitor_cdma_0/Data] [get_bd_addr_segs static_region/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xB0100000 -range 0x00080000 -target_address_space [get_bd_addr_spaces static_region/monitor_cdma_0/Data] [get_bd_addr_segs static_region/monitor_0/S01_AXI/S01_AXI_mem] -force
  assign_bd_address -offset 0xB0180000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/monitor_cdma_0/Data] [get_bd_addr_segs static_region/monitor_0/S02_AXI/S02_AXI_mem] -force

  # [MONITOR] AXI Sniffer
  assign_bd_address -offset 0x80800000 -range 0x00800000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/monitor_0/s_sniffer_in_axi/reg0] -force
  assign_bd_address -offset 0x80800000 -range 0x00800000 -target_address_space [get_bd_addr_spaces static_region/monitor_0/m_sniffer_out_axi] [get_bd_addr_segs dynamic_region/regslice_control_userpf_M_AXI/Reg] -force
  # [MONITOR] GPIO
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/axi_gpio_0/S_AXI/Reg] -force
